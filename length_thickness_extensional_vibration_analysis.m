...
for r = 1 : N_run
    ...
    if mod(r, 10) == 1
        fprintf('\n%4s %7s %6s %9s %9s %11s %11s %9s %9s %s %s\n', ...
            'Run', 'Error', 'NIter', 'Re(s11E)', 'Im(s11E)', ...
            'Re(eps33T)', 'Im(eps33T)', 'Re(d31)', 'Im(d31)', ...
            'IsFirstMode', 'IsPossible');
    end

    if E_run_min(r) < 1
        fprintf('%4d %6.2f%% %6d % 9.2e % 9.2e % 11.2e % 11.2e % 9.2e % 9.2e %11s %10s\n', ...
            ...
            string(isfirstmode_run(r)), string(ispossible_run(r)));
    else
        fprintf('%4d %6s%% %6d % 9.2e % 9.2e % 11.2e % 11.2e % 9.2e % 9.2e %11s %10s\n', ...
            r, '> 100', iter_run(r), ...
            real(s11E_run_opt(r)), imag(s11E_run_opt(r)), ...
            real(eps33T_run_opt(r)), imag(eps33T_run_opt(r)), ...
            real(d31_run_opt(r)), imag(d31_run_opt(r)), ...
